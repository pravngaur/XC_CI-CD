({
    ...
    requiredFieldsMap: {
        ...
        'DealSlowing': ['Reason'],
        'DealBoosting': ['Reason'],
        'WinningUnlikely': ['CloseDate','Reason'],
        'TimeConsumingOpportunity': ['Reason'],
        'ReEngaged': ['Reason', 'Activity'],
        'TaskOverdue': ['TaskDue', 'Activity'],
        'CloseDateOverdue': ['CloseDate'],
        'NoFutureActivity': [],
        'ProspectRaisedAnIssue': ['Activity'],
        'AmountMentioned': ['Activity'],
        'MeetingNeeded': [],
        'AmountOutlier': ['Activity']
    },
        ...
        return this.sendRequest(
            ...
            function(component, options){
                ...
                options = options.filter(function(option){
                    return self.excludedInsights.indexOf(option.value) == -1
                })
    ...
    getReasons : function(component){
        return this.sendRequest(
            ...
            function(component, options){
                let insight = component.get('v.insight');
                if(insight && insight.Reason){
                    options.map(function(option){
                        if( option.value == insight.Reason ){
                            option['selected'] = true;
                        }
                    })
                }
                component.set('v.reasonOptions', options)
            }
        );
    },
